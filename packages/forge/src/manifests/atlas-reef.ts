...
export function atlasReef(): GameManifest {
  return {
    ...
    theme: {
      ...
      assets: {
        background: '/assets/atlas-reef/backgrounds/background.png',
        symbols: {
          bubble: '/assets/atlas-reef/symbols/bubble.png',
          shell: '/assets/atlas-reef/symbols/shell.png',
          starfish: '/assets/atlas-reef/symbols/starfish.png',
          fish: '/assets/atlas-reef/symbols/fish.png',
          crab: '/assets/atlas-reef/symbols/crab.png',
          octopus: '/assets/atlas-reef/symbols/octopus.png',
          shark: '/assets/atlas-reef/symbols/shark.png',
          trident: '/assets/atlas-reef/symbols/trident.png',
          scatter: '/assets/atlas-reef/symbols/scatter.png',
          bomb: '/assets/atlas-reef/symbols/bomb.png',
        },
      },
    },
  };
