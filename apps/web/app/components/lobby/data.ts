...
export const HERO_SLIDES = [
  {
    ...
    art: '/assets/ember-falls/ui/lobby-card.png',
    title: 'EMBER FALLS',
    subtitle: 'Volkanik Vadide Basamaklı Kazançlar',
    desc: 'Tumble zinciri + free spin çarpan merdiveni — 5.000x max win',
    cta: 'HEMEN OYNA',
    ctaLink: '/games/ember-falls',
  ...
  },
  {
    ...
    art: '/assets/sugar-realm/ui/lobby-card.png',
    title: 'SUGAR REALM',
    subtitle: 'Zincirleme Patlamalar, Bomba Çarpanlar',
    desc: '6×5 scatter-pays + 100x bomba çarpanları — 10.000x max win',
    cta: 'HEMEN OYNA',
    ctaLink: '/games/sugar-realm',
  ...
  {
    id: 'welcome-bonus',
    art: '/assets/atlas-reef/ui/lobby-card.png',
    title: 'HOŞ GELDİN BONUSU',
    subtitle: '5.000 Coin hediye',
